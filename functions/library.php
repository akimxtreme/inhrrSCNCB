        ...
        echo '<div class="inner-wrap">';
            ...
            echo '<aside class="left-off-canvas-menu">';
                echo '<ul class="off-canvas-list">';
                    ...
                    */
                    // (1) Cuentas
                    echo '<li><label>(I) Cuentas CENSO</label></li>';
                    echo '<li><a href="mI_1-1.php"><small>(1.1)</small> Solicitudes <kbd>@</kbd></a></li>';
                    echo '<li><a href="mI_1-2.php"><small>(1.2)</small> Agregar Cuenta<kbd>@</kbd></a></li>';
                    echo '<li><a href="mI_1-3.php"><small>(1.3)</small> Modificar Cuenta<kbd>@</kbd></a></li>';
                    echo '<li><a href="mI_1-4.php"><small>(1.4)</small> Eliminar Cuenta<kbd>@</kbd></a></li>';
                    echo '<li><a href="mI_1-5.php"><small>(1.5)</small> Recuperar Cuenta Anulada<kbd>@</kbd></a></li>';
                    echo '<li><a href="mI_1-6.php"><small>(1.6)</small> Consultar Cuenta<kbd>@</kbd></a></li>';
                    
                    // (1) Cuentas
                    echo '<li><label>(II) Cuentas de Administrador</label></li>';
                    echo '<li><a href="mI_1-2.php"><small>(1.2)</small> Agregar Cuenta<kbd>@</kbd></a></li>';
                    echo '<li><a href="mI_1-3.php"><small>(1.3)</small> Modificar Cuenta<kbd>@</kbd></a></li>';
                    echo '<li><a href="mI_1-4.php"><small>(1.4)</small> Eliminar Cuenta<kbd>@</kbd></a></li>';
                    echo '<li><a href="mI_1-6.php"><small>(1.6)</small> Consultar Cuenta<kbd>@</kbd></a></li>';
